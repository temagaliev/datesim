...
class QuestionsViewController: UIViewController {
    ...
    private func setupViewController() {
        ...
        switch locationType {
        case .park:
            locationView.image = UIImage(named: NameImage.park.rawValue)
            arrayQuestions = questionsPerson.questionsPark
        case .beach:
            locationView.image = UIImage(named: NameImage.beach.rawValue)
            arrayQuestions = questionsPerson.questionsBeach
        case .cinema:
            locationView.image = UIImage(named: NameImage.cinema.rawValue)
            arrayQuestions = questionsPerson.questionsCinema
        case .mall:
            locationView.image = UIImage(named: NameImage.mall.rawValue)
            arrayQuestions = questionsPerson.questionsCinema
        case .restaurants:
            locationView.image = UIImage(named: NameImage.restaurants.rawValue)
            arrayQuestions = questionsPerson.questionsRestaurants
        }
